...
class LLM_Classifier:
    ...
    def api_call(self, images_base64: list[str]) -> int:
        ...
        system_prompt = (
            ...
            "incomplete or noisy that no tree structure can be recognised at all. Partial "
            "occlusion, minor clipping, or moderate artefacts are not reasons to return 19 "
            "— make your best species guess from the available evidence.\n"
            "</validation_rules>\n"
            "\n"
