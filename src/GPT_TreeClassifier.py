...
class LLM_Classifier:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
                ...
                "\n"
                "D. Uncertainty rule. If you have a coherent single tree but "
                "   would be guessing between three or more species with "
                "   roughly equal plausibility, return 19. Do NOT return 19 "
                "   when you can narrow to one or two plausible species and "
                "   pick the better fit.\n"
                "</validation_rules>\n"
                "\n"
                "<output_contract>\n"
